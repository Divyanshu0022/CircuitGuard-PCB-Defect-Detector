...
| :--- | :--- | :--- | :--- |
| **Milestone 1** | **Module 1** | **Dataset Setup & Image Subtraction** <br> (Image alignment, Grayscale conversion, Otsu's Thresholding) | ✅ **Done** |
| | **Module 2** | **Contour Detection & ROI Extraction** <br> (Finding defects, Bounding Boxes, Cropping samples) | ✅ **Done** |
| **Milestone 2** | Module 3 | Model Training (EfficientNet with PyTorch) | ⏳ *Pending* |
| | Module 4 | Prediction Pipeline & Validation | ⏳ *Pending* |
| **Milestone 3** | Module 5 | Frontend Web UI (Streamlit/HTML) | ⏳ *Pending* |
| | Module 6 | Backend Integration | ⏳ *Pending* |
